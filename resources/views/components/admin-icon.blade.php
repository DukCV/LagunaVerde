@php
    /*
     * Componente de iconos SVG inline para el panel de administración.
     *
     * Uso:  <x-admin-icon name="home" class="w-5 h-5 text-gray-700" />
     *
     * Fuente de los SVGs: Heroicons v2 (heroicons.com) — licencia MIT.
     * Se usan inline para evitar dependencias de red (flux:icon requiere SSL).
     *
     * Iconos disponibles (añadir más según se necesiten):
     *   home, newspaper, calendar-days, photo, user-group, users,
     *   chat-bubble-left-right, user, arrow-right-start-on-rectangle,
     *   x-mark, bars-3, bell, envelope, chevron-down, pencil-square,
     *   arrow-top-right-on-square, arrow-trending-up, eye,
     *   chat-bubble-oval-left, map-pin, user-plus, squares-2x2, phone,
     *   book-open, heart, scale, cpu-chip, gift
     */
    $svgs = [
        ...
        'arrow-right-start-on-rectangle' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9V5.25A2.25 2.25 0 0 1 10.5 3h6a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 16.5 21h-6a2.25 2.25 0 0 1-2.25-2.25V15M12 9l3 3m0 0-3 3m3-3H2.25" />',
        ...
        // ── Iconos para el módulo de gestión de noticias ─────────────────
        ...
        // ── Iconos para el módulo de toggle de estado ────────────────────
        // no-symbol: indica prohibición o deshabilitación de una acción
        ...
        // exclamation-triangle: advertencia de acción destructiva en el modal
        ...
        // check-circle: confirmación positiva en el modal de republicar
        ...
        // ── Iconos faltantes añadidos para optimización ────────────────────
        ...
        // ── Iconos para el sistema de programación de publicaciones ────────
        // clock: indica una acción programada para una fecha/hora futura
        'clock' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />',
        // lock-closed: indica un campo bloqueado para edición (fecha ya publicada)
        ...
        // ── Iconos para el módulo de gestión de eventos ─────────────────
        // tag: distintivo de categoría sobre la portada de la tarjeta
        ...
        // ── Iconos para el formulario de eventos (modalidad/ubicación) ──
        // globe-alt: modalidad virtual o híbrida
        ...
        // link: enlace de reunión virtual
        ...
        // chevron-right: navegación / control de slider de medios
        'chevron-right' => '<path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />',

        // ── Iconos para el módulo de gestión de socios colaboradores ────
        // building-office: distintivo de organización/tipo de socio (Corporativo)
        'building-office' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 21V4.5a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 .75.75V21M9 8.25h1.5m-1.5 3h1.5m-1.5 3h1.5m4.5-6h1.5m-1.5 3h1.5m-1.5 3h1.5M15.75 21v-3.375c0-.621-.504-1.125-1.125-1.125h-1.5c-.621 0-1.125.504-1.125 1.125V21" />',

        // ── Iconos de respaldo por categoría de socio (sin logotipo) ────
        // book-open: categoría "Educativo"
        ...
        // ── Iconos para el módulo de gestión de usuarios ────────────────
        // phone: número de teléfono en la tarjeta móvil del listado
    ...
    // Renderiza el SVG del icono solicitado; si no existe, muestra un cuadrado vacío como fallback
    $paths = $svgs[$name] ?? '<rect x="3" y="3" width="18" height="18" rx="2" stroke-width="1.5"/>';
@endphp

{{-- SVG inline: stroke-based, hereda color del texto (currentColor) --}}
<svg
